...
const BarChart = ({ getCounters, selectedLetter }: BarChartProps) => {
            ...
            <Bar
                data={{
                    ...
                    datasets: [
                        {
                            label: 'Amount',
                            data: [getCounters.containCounter, getCounters.startWithCounter,
                            getCounters.endWithCounter, getCounters.doubleCounter,
                            getCounters.letterInDictionaryCounter],
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
                                'rgba(255, 206, 86, 0.2)',
